...
const UserRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`http://localhost:8080/api/v1/userauth/userregister`, {
  ...
  return (
    ...
    <h1 className='text-center my-3'>Registration From</h1>
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          <input type="text"  placeholder="Enter your Phone Number"  className="form-control" id="phone" name='phone' onChange={onChange} minLength={4} required />
        </div>
        <div className="mb-3">
